...
function Star({ onRate, onMouseIn, onMouseout, full, color, size }) {
  ...
  return (
    <span style={starStyle} role="button" onClick={onRate} onMouseEnter={onMouseIn} onMouseLeave={onMouseout}>
      {full ? <svg
